    ...
    challenges = {
      ...
      "challenge03" = {
        ...
        servers = {
          ...
          #"challenge03-b" = { hostname = "b.challenge03.potluckctf.local", ip = "10.0.3.11", type = "e2-standard-2", labels = { challenge = 1, docker = 1 } },
        }
      },
      ...
      "challenge05" = {
        ...
        servers = {
          ...
          #"challenge05-b" = { hostname = "b.challenge05.potluckctf.local", ip = "10.0.5.11", type = "e2-standard-2", labels = { challenge = 1, docker = 1 } },
        }
      },
      ...
      "challenge07" = {
        ...
        servers = {
          ...
          #"challenge07-b" = { hostname = "b.challenge07.potluckctf.local", ip = "10.0.7.11", type = "e2-standard-2", labels = { challenge = 1, docker = 1 } },
        }
      },
      ...
      "challenge09" = {
        ...
        servers = {
          ...
          #"challenge09-b" = { hostname = "b.challenge09.potluckctf.local", ip = "10.0.9.11", type = "e2-standard-2", labels = { challenge = 1, docker = 1 } },
        }
      },
