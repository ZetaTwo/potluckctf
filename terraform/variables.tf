  ...
  server_settings = {
    ...
    challenges = {
      ...
      "challenge01" = {
        ...
        subnet = "10.0.1.0/24",
        servers = {
          "challenge01-a" = { ip = "10.0.1.10", type = "n2-standard-2", labels = { challenge = 1, docker = 1, docker_single = 1, nested_virtualization = 1 } },
        }
      },
      "challenge03" = {
      ...
      "challenge25" = {
        ...
        subnet = "10.0.25.0/24",
        servers = {
          "challenge25-a" = { ip = "10.0.25.10", type = "n2-standard-2", labels = { challenge = 1, nested_virtualization = 1 } },
        }
      },
      "challenge26" = {
